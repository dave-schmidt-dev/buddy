...
_ROSTER: list[dict] = [
    ...
    },
    {
        "name": "capybara",
        "body": "#b98a5a",
        "parts": {"a": "#7d5a38", "n": "#6f4f30"},
        # Warm tan, dark ears + blunt brown snout.
        "idle": _F(
            art=[
                "  n   n  ",
                " (o   o) ",
    ...
    },
    {
        "name": "dog",
        "body": "#d59a5a",
        "parts": {"a": "#a56a30", "g": "#e88aa0"},
        # Golden coat, brown floppy ears, pink tongue.
        "idle": _F(
            art=[
                " __   __ ",
                "(  o.o  )",
    ...
    },
    {
        "name": "sloth",
        "body": "#9fae7e",
        "parts": {"a": "#6f5a3e", "n": "#6f5a3e"},
        # Moss green, brown eye-mask + claws.
        "idle": _F(
            art=[
                "  (---)  ",
                "( \\o.o/ )",
    ...
    },
    {
        ...
        "body": "#c69a6a",
        "parts": {"a": "#6e4d34"},
        # Tan face, dark-brown quills over the crown.
        "idle": _F(
            art=[
                " ^^^^^^^ ",
                " ^(o.o)^ ",
    ...
    },
    {
        ...
        "body": "#c99a72",
        "parts": {"a": "#8a6647"},
        # Clay skin, darker banded armor shell.
        "idle": _F(
            art=[
                "  ,===.  ",
                " (=====) ",
